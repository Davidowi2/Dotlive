...
//#region node_modules/.nitro/vite/services/ssr/assets/Logo-DjsaxNDC.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("defs", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("linearGradient", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", {
					...
					offset: "100%",
					stopColor: "var(--color-moss, #4a7c59)"
				})]
...
function Logo({ className, tagline }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		to: "/",
		className: cn("flex items-center gap-2 group", className),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DotMark, { size: 32 }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex flex-col leading-none",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "font-display text-xl font-bold tracking-tight text-foreground group-hover:text-foreground/90 transition-colors",
				children: "DOT"
			}), tagline && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-[9px] tracking-widest uppercase text-muted-foreground font-medium mt-0.5",
				children: "Africa"
			})]
		})]
	});
