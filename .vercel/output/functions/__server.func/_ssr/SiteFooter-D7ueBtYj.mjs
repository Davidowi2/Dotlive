...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteFooter-D7ueBtYj.js
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: "sticky top-0 z-50 w-full border-b border-border/60 bg-background/95 backdrop-blur-xl",
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid gap-12 md:grid-cols-[1.5fr_repeat(4,1fr)]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "max-w-xs",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-5 text-xs leading-relaxed text-muted-foreground font-light",
					...
					className: "tracking-editorial text-foreground/70",
					children: col.title
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CookieSettingsLink, { className: "hover:text-foreground hover:underline underline-offset-4 transition-colors cursor-pointer" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"aria-hidden": true,
							children: "·"
						}),
