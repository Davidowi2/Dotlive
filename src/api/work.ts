...
/**
 * Work API — wraps the Fastify /api/services, /api/jobs, /api/orders endpoints.
 */
...
export interface ServiceFilters {
  ...
  sort?: "newest" | "most_popular" | "highest_rated" | "lowest_price" | "fastest_delivery";
}
...
export async function listServices(filters?: ServiceFilters): Promise<Service[]> {
  ...
  if (filters?.maxDeliveryDays !== undefined) params.set("maxDeliveryDays", String(filters.maxDeliveryDays));
